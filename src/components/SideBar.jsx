...
import EDUCRLogo from '../assets/EDUCRLogo.svg';
import {
  LayoutGrid,
  BookOpen,
  Users,
...
const Sidebar = ({ isMinimized, toggleSidebar }) => {
  ...
  const menuItems = [
    ...
    { name: "Sugerencias", path: "/calendarSuggestions", icon: GraduationCap },
    { name: "Asignaciones", path: "/calendarAssignments", icon: GraduationCap },
    { name: "Eventos", path: "/calendarEvents", icon: GraduationCap },
