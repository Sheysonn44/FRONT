...
const CalendarGrid = ({
  ...
  const handleEditActivity = (index) => {
    ...
    const activity = prompt("Ingrese nueva actividad (HC, AE, PyE, OI):", task.activity);
        ...
        {events.map((block, i) => {
          ...
          return (
            ...
            >
              ...
              <div className="mt-4">
                <div className="text-sm font-semibold select-none">{block.activity}</div>
                <div className="text-xs select-none">{dayLabel} {startTime} - {endTime}</div>
              </div>
            </Rnd>
          );
        })}
